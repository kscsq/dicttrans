...
public class DictionaryTransformationConsumer extends DefaultConsumer {
    private final DictionaryTransformationEndpoint endpoint;
    private final EventBusHelper eventBusHelper;

    private ExecutorService executorService;

    public DictionaryTransformationConsumer(DictionaryTransformationEndpoint endpoint, Processor processor) {
